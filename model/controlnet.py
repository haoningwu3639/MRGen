...
from model.unet_2d_blocks import UNetMidBlock2D, UNetMidBlock2DCrossAttn, get_down_block
...
class ControlNetModel(ModelMixin, ConfigMixin):
    ...
    def from_unet(
        ...
        controlnet = cls(
            ...
            conditioning_channels=conditioning_channels,
            # conditioning_channels=conditioning_channels * 4,
        )

        if load_weights_from_unet:
            # For 1 channel mask, while for 4 channles mask, omit this line
