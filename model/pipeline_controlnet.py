    ...
    def encode_prompt(
        ...
        if prompt_embeds is None:
            ...
            if clip_skip is None:
                ...
                prompt_embeds = self.text_encoder.text_model(text_input_ids.to(device), attention_mask=attention_mask)
        ...
        if do_classifier_free_guidance and negative_prompt_embeds is None:
            ...
            negative_prompt_embeds = self.text_encoder.text_model(uncond_input.input_ids.to(device), attention_mask=attention_mask)
