...
class StableDiffusionPipeline(DiffusionPipeline):
    def __init__(
        self,
        vae: AutoencoderKL,
        text_encoder: Union[AutoModel, CLIPTextModel],
        tokenizer: Union[AutoTokenizer, CLIPTokenizer],
    ...
    def _encode_prompt(
        ...
        text_embeddings = self.text_encoder.text_model(text_input_ids.to(device), attention_mask=attention_mask) # BiomedCLIP
        ...
        if do_classifier_free_guidance:
            ...
            uncond_embeddings = self.text_encoder.text_model(uncond_input.input_ids.to(device), attention_mask=attention_mask) # BiomedCLIP
