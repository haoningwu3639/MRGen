...
def train(
    ...
    # train_dataset = LiQA_CHAOS_MRI_Dataset(mode='train', modality='T1')
    # val_dataset = LiQA_CHAOS_MRI_Dataset(mode='test', modality='T1')
    train_dataset = LiQA_CHAOS_MRI_Dataset(mode='train', modality='T2-SPIR')
    val_dataset = LiQA_CHAOS_MRI_Dataset(mode='test', modality='T2-SPIR')
