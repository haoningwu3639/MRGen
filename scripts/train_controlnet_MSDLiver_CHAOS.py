...
def train(
    ...
    # train_dataset = MSD_Liver_CHAOS_MRI_Dataset(mode='train', modality='CT')
    # val_dataset = MSD_Liver_CHAOS_MRI_Dataset(mode='test', modality='CT')
    train_dataset = MSD_Liver_CHAOS_MRI_Dataset(mode='train', modality='T2-SPIR')
    val_dataset = MSD_Liver_CHAOS_MRI_Dataset(mode='test', modality='T2-SPIR')
