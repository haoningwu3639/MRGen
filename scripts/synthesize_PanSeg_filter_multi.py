...
def test(rank, world_size, args, shared_list):
    ...
    val_dataset = PanSeg_MRI_Dataset(modality=args.modality, mode='inference')
    ...
    for i, data in enumerate(progress_bar):
        ...
        if args.modality == 'T2':
            ...
            prompt = [", ".join(['T1 Abdomen MRI, fat high signal, muscle intermediate signal, water low signal, fat bright, water dark', data['region'][0], data['label'][0]])]
...
def main():
    ...
    parser.add_argument('--modality', type=str, choices=['T2', 'T1'], required=True)
