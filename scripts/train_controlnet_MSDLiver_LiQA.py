...
def train(
    ...
    # train_dataset = MSD_Liver_LiQA_Dataset(mode='train', modality='CT')
    # val_dataset = MSD_Liver_LiQA_Dataset(mode='test', modality='CT')
    train_dataset = MSD_Liver_LiQA_Dataset(mode='train', modality='T1')
    val_dataset = MSD_Liver_LiQA_Dataset(mode='test', modality='T1')
